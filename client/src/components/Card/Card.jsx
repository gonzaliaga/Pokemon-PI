...
export default function Card({ name, types, image, id, weight, height}){
    ...
    return(
        <div className={style.card} style={{ backgroundImage: `url(images/typesbkgm/${types[0]}.png)` }}>
            ...
            <span className={`${style.typetitle} ${typesColors[types[0]]}`}>Tipo</span>
            ...
            <span className={`${style.aboutitle} ${typesColors[types[0]]}`}>Acerca</span>
            <div className={style.about}>
                <div style={{display:'flex', flexDirection:'column'}}>
                    ...
                    <span className={style.weight}>Peso</span>
                </div>
                <div style={{display:'flex', flexDirection:'column', paddingLeft:'24%'}}>
                    ...
                    <span className={style.height}>Alto</span>    
                </div>
            </div>
