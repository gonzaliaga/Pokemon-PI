        ...
        <div className={style.pagina}>
            ...
            <Navbar/>
                ...
                <form onSubmit={ (e) => handleSubmit(e) }>
                    ...
                    <button onClick={(e) => {handleSection(e)}}>Siguiente</button>
                    </section>
                    <section className={section === 2 ? style.show : style.hide}>
                        <div style={{position:'relative'}}> 
                            <span className={style.choosetypes} style={{display:'flex', justifyContent:'flex-start', fontFamily:'Open Sans'}}>Elige hasta 2 tipos de Pokémon</span>
